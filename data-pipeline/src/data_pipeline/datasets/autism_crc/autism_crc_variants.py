...
def prepare_autism_crc_variants_helper(input_path: str, exomes_or_genomes: str):
...
#def prepare_autism_crc_variants(exome_variants_path: str, genome_variants_path: str):
def prepare_autism_crc_variants(genome_variants_path: str):
    # exome_variants = prepare_autism_crc_variants_helper(exome_variants_path, "exome")
    genome_variants = prepare_autism_crc_variants_helper(genome_variants_path, "genome")
